...
exports.bookinstance_delete_post = function(req, res, next) {
  ...
  BookInstance.findByIdAndRemove(instanceid)
    .exec()
...
exports.bookinstance_update_get = function(req, res, next) {
  ...
  Promise.all([Book.find({}, "title").exec(), BookInstance.findById(id).exec()])
    .then(results => {
      const [books, instance] = results;
      if (!instance) {
...
exports.bookinstance_update_post = [
  ...
  function(req, res, next) {
    ...
    BookInstance.findByIdAndUpdate(id, instance)
      .exec()
      .then(() => {
